        ...
        <div class="bottomContainer">
            ...
            <div class="settingsForm">
                <div style="display: flex;  flex-direction: column; width: fit-content;">
                    <div class="tabs">
                        <h3 class="activeTab tabHeader" onclick="changeTab(this, 'main')">Haupteinstellungen</h3>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <h3 class="tabHeader" onclick="changeTab(this, 'variable')">Eigene Variabel erstellen</h3>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <h3 class="tabHeader" onclick="changeTab(this, 'export')">Export/Import</h3>
                    </div>
                    <div class="settingsTab" id="mainSettingsTab">
                        <label id="apiKeyLabel" for="apiKey">OpenAI Apikey <a target="_blank" href="https://platform.openai.com/overview">
                    ...
                    <div class="settingsTab" id="variableSettingsTab" style="display: none;">
                        <div id="variablenContainer" class="variablenContainer">
                            <div class="variable">
                                <input type="text" name="variableName" id="variableName" class="variableInput" placeholder="Name der Variable">
                                <span class="variableSpan">=></span>
                                <textarea name="variableValue" id="variableValue" class="variableInput variableInputWert" placeholder="Wert" cols="30" rows="1"></textarea>
                            </div>
                        </div>

                        <div class="rightButton" style="padding-bottom: 20px;">
                            <button onclick="addVariable()">Variable hinzufügen</button>
                            <button onclick="saveVariableSettings()">Einstellungen übernehmen</button>
                        </div>
                    </div>
                    <div class="settingsTab" id="exportSettingsTab" style="display: none;">
                        <div class="rightButton" style="display: flex;">
                            ...
                            <button onclick="importJson('settings')">Einstellungen importieren</button>
                        </div>
                        <br>
                        <div class="rightButton" style="display: flex;">
                            <div class="custom-file-upload" id="drop-area-templates">
                            ...
                            <p id="templatesFileText"></p>
                            <button onclick="importJson('templates')">Vorlagen importieren</button>
                        </div>
                        <br>
