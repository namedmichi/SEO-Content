/******/ (() => {
  ...
  \********************/
			/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				/* harmony import */ var _components_dashboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
				...
				const App = () => {
					return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						...
						(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							_components_dashboard__WEBPACK_IMPORTED_MODULE_2__['default'],
							null
						)
					);
				};
				...
				registerBlockType('namedmichi/seocontentblock', {
					...
					edit: (props) => {
						...
						return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							'div',
							useBlockProps(),
							(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockControls, null),
							(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
  ...
  \**************************************/
		...
		/***/ './src/components/toolbar_button.jsx':
			/*!*******************************************!*\
  !*** ./src/components/toolbar_button.jsx ***!
  \*******************************************/
			/***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
				...
				/* harmony import */ var react_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
					/*! react-modal */ './node_modules/react-modal/lib/index.js'
				);
				/* harmony import */ var react_modal__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/ __webpack_require__.n(
					react_modal__WEBPACK_IMPORTED_MODULE_5__
				);
				...
				const Download = (BlockEdit) => {
					return (props) => {
						...
						react_modal__WEBPACK_IMPORTED_MODULE_5___default().setAppElement('body');
						return (0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							...
							(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
								...
								(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
									...
									(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)('h2', null, 'Keyword Optimierung'),
									(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
										'form',
										{
											action: '',
									...
									(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
										'div',
										{
											id: 'seo_keyword_button_container',
										},
										(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
											'button',
											{
												class: 'button button-primary nmdButtonForm',
												type: 'submit',
								...
								(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
									react_modal__WEBPACK_IMPORTED_MODULE_5___default(),
									{
										...
										style: customStyles,
										contentLabel: '\xDCbersetzen',
									},
									(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)('h2', null, '\xDCbersetzen'),
									(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
										'form',
										{
											action: '',
											method: 'post',
											id: 'seo_translate_form',
										},
										(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
											'label',
											{
								...
								(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
									_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarDropdownMenu,
									{
										icon: 'seologo',
				...
				async function test_content(content, props) {
					if (props.name == 'core/list') {
						document.getElementById('block-' + props.clientId).style.animation =
							'1.3s linear 0s infinite normal none running nmd-fading';
						return content;
					}
					if (content == undefined) {
						try {
							...
							if (content == undefined) {
								alert(
									'Es konnte kein Text gefunden werden. Bitte wählen Sie einen anderen Block aus oder wenden Sie sich an den Support'
								);
								return;
							}
						} catch {
				...
				async function gpt_make_request(content, props, prompt) {
					...
					try {
						const response = await axios__WEBPACK_IMPORTED_MODULE_6__['default'].post(
							API_ENDPOINT,
							{
								messages: chat,
								temperature: 0.6,
							...
							if (choices && choices.length > 0) {
								...
								if (props.name == 'core/list') {
									...
									for (let i = 0; i < contentJsonArray.length; i++) {
										(0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getBlock(
											listItemClientIdsArray[i]
										).attributes.content = contentJsonArray[i].trim().replace(/^"(.*)"$/, '$1');
										var updatedAttributes = (0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)(
											'core/block-editor'
										).getBlock(listItemClientIdsArray[i]).attributes;
										(0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)('core/block-editor').updateBlock(
											listItemClientIdsArray[i],
											updatedAttributes
										);
									}
								...
								if (
									(0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getBlock(blockId)
										.attributes.content != undefined
								) {
									(0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getBlock(
										blockId
									).attributes.content = content.trim().replace(/^"(.*)"$/, '$1');
								} else {
									(0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getBlock(
										blockId
									).attributes.text = content.trim().replace(/^"(.*)"$/, '$1');
								}
								var updatedAttributes = (0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)(
									'core/block-editor'
								).getBlock(blockId).attributes;
								(0, _wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)('core/block-editor').updateBlock(
									blockId,
									updatedAttributes
								);
...
*/
							...
							(_ret =
								((_temp =
									((_this = _possibleConstructorReturn(
										this,
										(_ref = Modal.__proto__ || Object.getPrototypeOf(Modal)).call.apply(_ref, [this].concat(args))
									)),
									_this)),
				...
				var ModalPortal = (function (_Component) {
					...
					function ModalPortal(props) {
						...
						_this.buildClassName = function (which, additional) {
							var classNames =
								(typeof additional === 'undefined' ? 'undefined' : _typeof(additional)) === 'object'
									? additional
									: {
						...
						},
						{
							...
							value: function render() {
								...
								var contentProps = _extends(
									...
									this.attributesFromObject('aria', _extends({ modal: true }, this.props.aria)),
				...
				/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = {
					getAdapter: (adapters) => {
						...
						for (let i = 0; i < length; i++) {
							...
							if (
								(adapter = _utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].isString(nameOrAdapter)
  ...
  \************************************************/
			/***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
				...
				/* harmony import */ var _core_settle_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
					/*! ./../core/settle.js */ './node_modules/axios/lib/core/settle.js'
				);
				/* harmony import */ var _helpers_cookies_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
					/*! ./../helpers/cookies.js */ './node_modules/axios/lib/helpers/cookies.js'
				);
				/* harmony import */ var _helpers_buildURL_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
					/*! ./../helpers/buildURL.js */ './node_modules/axios/lib/helpers/buildURL.js'
				);
				/* harmony import */ var _core_buildFullPath_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
					/*! ../core/buildFullPath.js */ './node_modules/axios/lib/core/buildFullPath.js'
				);
				/* harmony import */ var _helpers_isURLSameOrigin_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
					/*! ./../helpers/isURLSameOrigin.js */ './node_modules/axios/lib/helpers/isURLSameOrigin.js'
				);
				/* harmony import */ var _defaults_transitional_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
					/*! ../defaults/transitional.js */ './node_modules/axios/lib/defaults/transitional.js'
				);
				/* harmony import */ var _core_AxiosError_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
					/*! ../core/AxiosError.js */ './node_modules/axios/lib/core/AxiosError.js'
				);
				/* harmony import */ var _cancel_CanceledError_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
					/*! ../cancel/CanceledError.js */ './node_modules/axios/lib/cancel/CanceledError.js'
				);
				/* harmony import */ var _helpers_parseProtocol_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
					/*! ../helpers/parseProtocol.js */ './node_modules/axios/lib/helpers/parseProtocol.js'
				);
				/* harmony import */ var _platform_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
				...
				/* harmony import */ var _helpers_speedometer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
					...
					function (config) {
						return new Promise(function dispatchXhrRequest(resolve, reject) {
							...
							if (_utils_js__WEBPACK_IMPORTED_MODULE_2__['default'].isFormData(requestData)) {
								if (
									_platform_index_js__WEBPACK_IMPORTED_MODULE_3__['default'].isStandardBrowserEnv ||
									_platform_index_js__WEBPACK_IMPORTED_MODULE_3__['default'].isStandardBrowserWebWorkerEnv
								) {
							...
							const fullPath = (0, _core_buildFullPath_js__WEBPACK_IMPORTED_MODULE_4__['default'])(
								config.baseURL,
								config.url
							);
							...
							request.ontimeout = function handleTimeout() {
								let timeoutErrorMessage = config.timeout
									...
									: 'timeout exceeded';
								const transitional =
									config.transitional || _defaults_transitional_js__WEBPACK_IMPORTED_MODULE_8__['default'];
								...
								reject(
									new _core_AxiosError_js__WEBPACK_IMPORTED_MODULE_7__['default'](
										...
										transitional.clarifyTimeoutError
											? _core_AxiosError_js__WEBPACK_IMPORTED_MODULE_7__['default'].ETIMEDOUT
											: _core_AxiosError_js__WEBPACK_IMPORTED_MODULE_7__['default'].ECONNABORTED,
										config,
										request
									)
							...
							if (_platform_index_js__WEBPACK_IMPORTED_MODULE_3__['default'].isStandardBrowserEnv) {
								...
								const xsrfValue =
									(config.withCredentials ||
										(0, _helpers_isURLSameOrigin_js__WEBPACK_IMPORTED_MODULE_9__['default'])(fullPath)) &&
									config.xsrfCookieName &&
									_helpers_cookies_js__WEBPACK_IMPORTED_MODULE_10__['default'].read(config.xsrfCookieName);
							...
							if (config.cancelToken || config.signal) {
								...
								onCanceled = (cancel) => {
									...
									reject(
										!cancel || cancel.type
											? new _cancel_CanceledError_js__WEBPACK_IMPORTED_MODULE_11__['default'](null, config, request)
											: cancel
									);
									request.abort();
									request = null;
  ...
  \*****************************************/
			/***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
				...
				/* harmony import */ var _helpers_HttpStatusCode_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
  ...
  \****************************************************/
			/***/ (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
				...
				const headersToObject = (thing) =>
					thing instanceof _AxiosHeaders_js__WEBPACK_IMPORTED_MODULE_0__['default'] ? thing.toJSON() : thing;
  ...
  \**********************/
		...
		/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
			/*! @wordpress/hooks */ '@wordpress/hooks'
		);
		/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
		...
		/* harmony import */ var _src_components_toolbar_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
			/*! ../src/components/toolbar_button */ './src/components/toolbar_button.jsx'
		);
		/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
			/*! @wordpress/blocks */ '@wordpress/blocks'
		);
		/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/ __webpack_require__.n(
			_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__
		);
		/* harmony import */ var _src_components_ai_block__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
			/*! ../src/components/ai_block */ './src/components/ai_block.jsx'
		);
		/* harmony import */ var _style_main_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
		...
		(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.render)(
			(0, _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_app__WEBPACK_IMPORTED_MODULE_1__['default'], null),
