...
const App = () => {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    className: "app-title"
  }, "K\xFCchenGPT"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_dashboard__WEBPACK_IMPORTED_MODULE_2__["default"], null));
};
...
registerBlockType('namedmichi/seocontentblock', {
  ...
  edit: props => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", useBlockProps(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockControls, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalInputControl, {
      ...
      class: "lds-roller"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null))));
    async function gpt_call() {
      ...
      }).then(response => response.json()).then(data => result = data.choices[0].text.split('\n').slice(1).slice(1).join('\n')).then(data => console.log(result)).then(data => {
  ...
  save: props => {
    ...
    }), attributes.activateLasers && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "lasers"
    }, "Lasers activated"));
  }
});
...
const Dashboard = () => {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "card"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, "Dashboard"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null)));
};
...
const Download = BlockEdit => {
  return props => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_modal__WEBPACK_IMPORTED_MODULE_5___default()), {
      isOpen: modalIsOpen,
      onAfterOpen: afterOpenModal,
      onRequestClose: closeModal,
      style: customStyles,
      contentLabel: "Keyword Optimierung"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "Keyword Optimierung"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
      action: "",
      method: "post",
      id: "seo_keyword_form"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
      htmlFor: "keyword"
    }, "Keyword"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
      name: "keyword",
      id: "keyword",
      type: "text"
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
      htmlFor: "count"
    }, "Anzahl im Text"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
      type: "number",
      name: "count",
      id: "count"
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, ' ', "Absenden"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      class: "button button-primary nmdButtonForm",
      onClick: closeModal
    }, "Schlie\xDFen"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react_modal__WEBPACK_IMPORTED_MODULE_5___default()), {
      isOpen: modalIsOpen2,
      onAfterOpen: afterOpenModal2,
      onRequestClose: closeModal2,
      style: customStyles,
      contentLabel: "\xDCbersetzen"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "\xDCbersetzen"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
      action: "",
      method: "post",
      id: "seo_translate_form"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
      htmlFor: "sprache"
    }, "Sprache:"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
      name: "sprache",
      id: "sprache",
      type: "text"
    })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      class: "button button-primary nmdButtonForm",
      onClick: closeModal2
    }, "Schlie\xDFen"))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.ToolbarDropdownMenu, {
      icon: "seologo",
...
async function gpt_toolbar(content, selection, props) {
  ...
  var chat = [{
    role: 'system',
    content: 'You are a helpful assistant speaking German. You are a creativ Textwriter that helps with SEO and Text optimization. Complete my Promts. Dont say anything else except the answer to my Prompt'
  }];
  chat.push({
    role: 'user',
    content: prompt
  ...
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_6__["default"].post(API_ENDPOINT, {
      messages: chat,
      max_tokens: tokens,
      temperature: 0.6,
      model: 'gpt-4',
    ...
    if (response.status === 200) {
      ...
      if (choices && choices.length > 0) {
        ...
        console.log(content);
        var blockId = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().clientId;
        console.log('BLock	ID: ' + blockId);
        (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().attributes.content = content.trim().replace('"', '');
        var updatedAttributes = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().attributes;
        (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)('core/block-editor').updateBlock(blockId, updatedAttributes);
    ...
    alert('Es ist ein Fehler aufgetreten. Bitte warten Sie ein paar Sekunden und versuchen es dan erneut. Bei weiteren Probleme kontaktieren Sie bitte den Support');
    throw error;
  }
  ...
  }).then(response => response.json()).then(data => result = data.choices[0].text).then(data => console.log(result)).then(data => {
    console.log(result);
    console.log((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock());
    var blockId = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().clientId;
    console.log('BLock	ID: ' + blockId);
    (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().attributes.content = result;
    var updatedAttributes = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().attributes;
    (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)('core/block-editor').updateBlock(blockId, updatedAttributes);
    document.getElementById('block-' + props.clientId).style.animation = '';
    console.log(updatedAttributes);
...
async function gpt_toolbar_keyword(content, props, keyword, count) {
  ...
  var chat = [{
    role: 'system',
    content: 'You are a helpful assistant speaking German. You are a creativ Textwriter that helps with SEO and Text optimization. Complete my Promts:'
  }];
  chat.push({
    role: 'user',
    content: prompt
  ...
  try {
    ...
    if (response.status === 200) {
      ...
      if (choices && choices.length > 0) {
        ...
        var blockId = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().clientId;
        console.log('BLock	ID: ' + blockId);
        (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().attributes.content = content.trim();
        var updatedAttributes = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.select)('core/block-editor').getSelectedBlock().attributes;
        (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.dispatch)('core/block-editor').updateBlock(blockId, updatedAttributes);
        document.getElementById('block-' + props.clientId).style.animation = '';
        console.log(updatedAttributes);
...
/* harmony import */ var _src_components_toolbar_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../src/components/toolbar_button */ "./src/components/toolbar_button.jsx");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _src_components_ai_block__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../src/components/ai_block */ "./src/components/ai_block.jsx");
/* harmony import */ var _style_main_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./style/main.scss */ "./src/style/main.scss");
